...
'modules' => [
    ...
    'admin' => [
        'class' => 'apaoww\AdminRedis\Module',
        'layout' => 'left-menu', // it can be '@path/to/your/layout'.
        'controllerMap' => [
            'assignment' => [
                'class' => 'apaoww\AdminRedis\controllers\AssignmentController',
...
The code below shows how to use ACF which is implemented as `apaoww\AdminRedis\components\AccessControl`:

```php
'as access' => [
    'class' => 'apaoww\AdminRedis\components\AccessControl',
    'allowActions' => [
        'site/login',
        'site/error',
    ]
