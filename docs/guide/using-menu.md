...
Return of `apaoww\AdminRedis\components\MenuHelper::getAssignedMenu()` has default format like:
...
return format of `apaoww\AdminRedis\components\MenuHelper::getAssignedMenu()` by provide a callback to this method.
...
Using Sparated Menu
-------------------
Second parameter of `apaoww\AdminRedis\components\MenuHelper::getAssignedMenu()` used to get menu on it's own hierarchy.
